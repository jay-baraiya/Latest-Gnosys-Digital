<x-master-layout>
    <x-form-wrapper action="{{ isset($action) ? $action : (isset($ticket) ? 'Edit' : 'Create') }}">
            ...
            <div class="card-body pb-0 pt-0 px-2">
                <ul class="nav nav-tabs nav-bordered nav-bordered-primary">
                    <li class="nav-item me-3">
                        <a href="{{ $url }}?tab=ticket-form" data-tab="ticket-form" class="nav-link p-2 {{ $tab == 'ticket-form' ? 'active' : '' }}">
                            <i class="ti ti-ticket  me-2"></i>Ticket
                        </a>
                    </li>
                    <li class="nav-item me-3">
                        <a href="{{ $url }}?tab=tasks-form" data-tab="tasks-form" class="nav-link p-2 {{ $tab == 'tasks-form' ? 'active' : '' }}">
                            <i class="ti ti-list me-2"></i>Tasks
                        </a>
                    </li>
                    <li class="nav-item me-3">
                        <a href="{{ $url }}?tab=chats-form" data-tab="chats-form" class="nav-link p-2 {{ $tab == 'chats-form' ? 'active' : '' }}">
        ...
        <div class="row tabHide" id="tasks-form" style="display: {{ $tab != 'tasks-form' ? 'none' : '' }};">
                        ...
                        <tbody id="orderItemsBody">
                                ...
                                @foreach ($tasks as $index => $item)
                                    ...
                                    <tr class="order-item-row">
                                        <td>
                                            ...
                                            <input type="hidden" name="product_type[{{ $index }}]" class="item-type-hidden" value="{{ $isProduct ? 'product' : 'service' }}">
                                            ...
                                            <select class="form-select product-select" name="product_id[{{ $index }}]" required>
                                        ...
                                        <td>
                                            ...
                                            @endphp
                                            <select class="form-select variant-select {{ $hasVariants ? 'variant-select-required' : '' }}" name="variant_id[{{ $index }}]" {{ $hasVariants ? '' : 'readonly' }}>
                                        ...
                                        <td>
                                            <input type="number" class="form-control item-qty" name="quantity[{{ $index }}]"
                                                min="1" value="{{ $item->quantity ?? 1 }}" placeholder="1" required>
                                        </td>
                                        <td>
                                            <div class="input-group">
                                                <span class="input-group-text">$</span>
                                                <input type="number" step="0.01" class="form-control item-price" name="price[{{ $index }}]"
                            ...
                            @else
                                ...
                                <tr class="order-item-row">
                                    ...
                                    <td>
                                        <input type="number" class="form-control item-qty" name="quantity[0]"
