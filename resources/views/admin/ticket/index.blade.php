<x-master-layout>
        ...
        <x-card>
                ...
                <div class="card-body pb-0 pt-0 px-2">
                    <ul class="nav nav-tabs nav-bordered nav-bordered-primary">
                        <li class="nav-item me-3">
                            <a href="#" data-type="priority" data-value="Low"
                                class="nav-link filter-tab p-2 {{ $priority == 'Low' ? 'active' : '' }}">
                                Low
                            </a>
                        </li>
                        <li class="nav-item me-3">
                            <a href="#" data-type="priority" data-value="Medium"
                                class="nav-link filter-tab p-2 {{ $priority == 'Medium' ? 'active' : '' }}">
                                Medium
                            </a>
                        </li>
                        <li class="nav-item me-3">
                            <a href="#" data-type="priority" data-value="High"
                                class="nav-link filter-tab p-2 {{ $priority == 'High' ? 'active' : '' }}">
                                High
                            </a>
                        </li>
                    </ul>
            ...
            {{-- <div class="card border-0">
                <div class="card-body pb-0 pt-0 px-2">
                    <ul class="nav nav-tabs nav-bordered nav-bordered-primary">
                        <li class="nav-item me-3">
                            <a href="#" data-type="status" data-value="pending"
                                class="nav-link filter-tab p-2 {{ $status == 'pending' ? 'active' : '' }}">
                                Pending
                            </a>
                        </li>
                        <li class="nav-item me-3">
                            <a href="#" data-type="status" data-value="assigned"
                                class="nav-link filter-tab p-2 {{ $status == 'assigned' ? 'active' : '' }}">
                                Assigned
                            </a>
                        </li>
                        <li class="nav-item me-3">
                            <a href="#" data-type="status" data-value="in_progress"
                                class="nav-link filter-tab p-2 {{ $status == 'in_progress' ? 'active' : '' }}">
                                In Progress
                            </a>
                        </li>
                        <li class="nav-item me-3">
                            <a href="#" data-type="status" data-value="completed"
                                class="nav-link filter-tab p-2 {{ $status == 'completed' ? 'active' : '' }}">
                                Completed
                            </a>
                        </li>
                        <li class="nav-item me-3">
                            <a href="#" data-type="status" data-value="cancelled"
                                class="nav-link filter-tab p-2 {{ $status == 'cancelled' ? 'active' : '' }}">
                                Cancelled
                            </a>
                        </li>
                    </ul>
            ...
            <x-slot:header>
                <div class="d-flex align-items-center flex-wrap gap-2 w-100">
                    ...
                    <div style="min-width: 180px;">
                        <select name="filter_ticket_number" id="filter-ticket-number"
                            class="form-control filter_ticket_number">
    ...
    <div id="viewTicketListModal" class="modal fade" tabindex="-1" role="dialog"
        aria-labelledby="viewTicketListModalLabel" aria-hidden="true">
