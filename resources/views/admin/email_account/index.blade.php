    ...
    <div class="content pb-0">
        ...
        <x-card>
            <x-slot:header>
                ...
                <a href="{{ route('admin.email_accounts.create') }}" class="btn btn-primary"><i
            ...
            $(document).ready(function() {
                if ($('#manage-module-list').length > 0) {
                    var table = $('#manage-module-list').DataTable({
                        ...
                        "serverSide": true,
                        "ajax": {
                            "url": "{{ route('admin.email_accounts.getData') }}",
                            "type": "POST",
                            data: function(d) {
                        ...
                        drawCallback: function(settings) {
                            var api = this.api();
                            $('.record-count').text(api.ajax.json().total_email_accounts ?? 0);
                        },
                        "columns": [
                            {
                                "data": "DT_RowIndex",
