    ...
    <div class="content pb-0">
        ...
        <x-page-header title="Manage {{ $moduleName }}" badge="0">
            ...
            <x-slot:actions>
                ...
                <a href="javascript:void(0);" class="btn btn-icon btn-outline-light shadow" data-bs-toggle="tooltip"
                    data-bs-placement="top" aria-label="Refresh" data-bs-original-title="Refresh" data-value="0"><i
        ...
        <x-card>
            ...
            <x-slot:header>
                ...
                @can('create.digital.products')
                <a href="{{ route('admin.digital.products.create') }}" class="btn btn-primary"><i
        ...
        $(document).ready(function() {
            if ($('#manage-module-list').length > 0) {
                ...
                var table = $('#manage-module-list').DataTable({
                    ...
                    "serverSide": true,
                    "ajax": {
                        "url": "{{ route('admin.digital.products.getData') }}",
                        "type": "POST",
                        data: function(d) {
                    ...
                    drawCallback: function(settings) {
                        var api = this.api();
                        $('.record-count').text(api.ajax.json().total_digital_products ?? 0);
                    },
                    "columns": [{
                            "data": "DT_RowIndex",
                            "name": "DT_RowIndex",
