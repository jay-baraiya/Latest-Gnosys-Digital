<x-master-layout>
    <x-form-wrapper action="{{ isset($action) ? $action : (isset($digitalproduct) ? 'Edit Digital Product' : 'Create Digital Product') }}">
        <form id="digitalProductForm"
            action="{{ isset($digitalproduct) ? route('admin.digital.products.update', encrypt($digitalproduct->id)) : route('admin.digital.products.store') }}"
            method="post"
            enctype="multipart/form-data">

            @csrf
            @if (isset($digitalproduct))
                @method('PUT')
            @endif
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="mb-3">
                        ...
                        <input type="hidden" name="remove_existing_project" id="remove_existing_project" value="0">

                        <input type="file" name="project" id="project" class="form-control" accept=".zip,application/zip,application/x-zip-compressed">
                ...
                <div class="col-md-12">
                    <div class="mb-3">
                        ...
                        <input type="hidden" name="description" id="description" value="{{ old('description', $digitalproduct->description ?? '') }}">
            ...
            <input type="hidden" name="custom_field[module_type]" value="product">
