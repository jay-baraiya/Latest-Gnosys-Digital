    ...
    <x-form-wrapper action="{{ isset($action) ? $action : (isset($digitalservice) ? 'Edit Digital Service' : 'Create Digital Service') }}">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <div class="input-group mb-1">
                            <input disabled type="text" class="form-control" name="name" id="name" placeholder="Enter service name"
                ...
                <div class="col-lg-4">
                    ...
                    <input disabled type="text" name="tags" id="tags" class="form-control", value="{{ !empty($digitalservice->tags) ? $digitalservice->tags : '' }}" placeholder="Enter tags..." data-choices>
                </div>
                ...
                <div class="col-md-12">
                    <div class="mb-3">
                        ...
                        <textarea disabled class="form-control" name="short_description" id="short_description" rows="2" placeholder="Brief summary">{{ old('short_description', $digitalservice->short_description ?? '') }}</textarea>
                ...
                <div class="col-md-12">
                    <div class="mb-3">
                        ...
                        <input disabled type="hidden" name="description" id="description" value="{{ old('description', $digitalservice->description ?? '') }}">
            ...
            <input disabled type="hidden" name="custom_field[module_type]" value="service">
