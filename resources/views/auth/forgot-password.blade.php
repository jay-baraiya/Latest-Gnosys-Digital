                ...
                <div class="col-lg-6 vh-100 overflow-y-auto overflow-x-hidden">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10 mx-auto">
                            ...
                            <form method="POST" action="{{ route('password.email') }}" class=" vh-100 d-flex justify-content-between flex-column p-4 pb-0">
                                @csrf
                                ...
                                <div>
                                    ...
                                    <div class="mb-3 text-center">
                                        <p class="mb-0">Back to <a href="{{ route('login') }}" class="link-indigo fw-bold link-hover"> Sign In</a></p>
                                    </div>
                                </div>
